...
from collective.easyformplugin.simple.browser.widgets import ConsentFieldWidget
from collective.easyformplugin.simple.browser.widgets import DividerFieldWidget
